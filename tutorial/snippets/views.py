...
class SnippetViewSet(viewsets.ModelViewSet):
    """
    This viewset automatically privides `list`, `create`, `retrieve`,
    `update` and `destroy` actions.

    Additionally we also privide an extra `highlight` action.
    """
...
"""===== Class-based views implementations ====="""
...
#     """
#     List all snippets, ir create a new snippet.
#     """
...
"""===== Function based views implementations ====="""
